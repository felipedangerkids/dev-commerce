...
@endif
<form enctype="multipart/form-data" method="POST" action="{{ url('products-update/'. $product->id) }}">
      ...
      <div class=" bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:grid gap-4 grid-cols-3">
                  <div class="mb-4">
                        ...
                        <input type="text"
                              ...
                              id="exampleFormControlInput1" placeholder="Código do produto" value="{{ $product->code }}"
                              name="code" required>
                  ...
                  <div class="mb-4 col-start-2 col-end-4">
                        ...
                        <input type="text"
                              class="shadow appearance-none border rounded  w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              id="exampleFormControlInput1" placeholder="Nome do Produto" value="{{ $product->name }}"
                              name="name" required>
            ...
            <div class="sm:grid gap-4 grid-cols-1">
                  <div class="mb-4">
                        <label for="exampleFormControlInput1" class="block text-gray-700 text-sm font-bold mb-2">Breve
                              Descrição:</label>
                        <input type="text"
                              class="shadow appearance-none border rounded  w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              id="exampleFormControlInput1" value="{{ $product->short_description }}"
                              placeholder="Breve descrição do produto" name="short_description">
                        @error('short_description') <span class="text-red-500">{{ $message }}</span>@enderror
                  </div>
            </div>
            <div class="sm:grid gap-4 grid-cols-3">
                  <div class="mb-4">
                        <label for="exampleFormControlInput1" class="block text-gray-700 text-sm font-bold mb-2">Cor
                              :</label>
                        <input type="text"
                              class="shadow appearance-none border rounded  w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              id="exampleFormControlInput1" value="{{ $product->colors }}" placeholder="Cor do Produto"
                              name="colors">
                        @error('colors') <span class="text-red-500">{{ $message }}</span>@enderror
                  </div>
                  <div class="mb-4">
                        <label for="exampleFormControlInput1" class="block text-gray-700 text-sm font-bold mb-2">Familia
                              :</label>
                        <input type="text"
                              class="shadow appearance-none border rounded  w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              id="exampleFormControlInput1" placeholder="Familia do Produto"
                              value="{{ $product->family }}" name="family">
                        @error('family') <span class="text-red-500">{{ $message }}</span>@enderror
                  </div>
                  <div class="mb-4">
                        <label for="exampleFormControlInput1" class="block text-gray-700 text-sm font-bold mb-2">Tipo da
                              venda:</label>
                        <select name="type_sale"
                              ...
                              @error('type_sale') <span class="text-red-500">{{ $message }}</span>@enderror
                        </select>
            ...
            <div class="sm:grid gap-4 grid-cols-3">
                  <div class="mb-4">
                        <label for="exampleFormControlInput1" class="block text-gray-700 text-sm font-bold mb-2">Preço
                              :</label>
                        <input type="text"
                              class="shadow appearance-none border rounded  w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              id="price" placeholder="Preço do Produto" value="{{ $product->price }}" name="price">
                  ...
                  <div class="mb-4">
                        ...
                        <input type="text"
                              class="shadow appearance-none border rounded  w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              id="price_promotional" value="{{ $product->promotional_price }}"
                              placeholder="Preço em promoção" name="promotional_price">
                        @error('promotional_price') <span class="text-red-500">{{ $message }}</span>@enderror
                  </div>
                  <div class="mb-4">
                        <label for="exampleFormControlInput1" class="block text-gray-700 text-sm font-bold mb-2">Marca
                              :</label>
                        <input type="text"
                              class="shadow appearance-none border rounded  w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              id="exampleFormControlInput1" value="{{ $product->brand }}" placeholder="Marca do Produto"
                              name="brand">
            ...
            <div class="sm:grid gap-4 grid-cols-4">
                  <div class="mb-4">
                        <label for="exampleFormControlInput1" class="block text-gray-700 text-sm font-bold mb-2">Tamanho
                              :</label>
                        <input type="text"
                              class="shadow appearance-none border rounded  w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  ...
                  <div class="mb-4">
                        <label for="exampleFormControlInput1" class="block text-gray-700 text-sm font-bold mb-2">Altura
                              :</label>
                        <input type="text"
                              class="shadow appearance-none border rounded  w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  ...
                  <div class="mb-4">
                        ...
                        <input type="text"
                              ...
                              value="{{ $product->diameter }}" name="diameter">
                        @error('diameter') <span class="text-red-500">{{ $message }}</span>@enderror
                  </div>
                  <div class="mb-4">
                        <label for="exampleFormControlInput1" class="block text-gray-700 text-sm font-bold mb-2">Peso
                              :</label>
                        <input type="text"
                              class="shadow appearance-none border rounded  w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                              id="exampleFormControlInput1" placeholder="Peso do Produto" value="{{ $product->weight }}"
                              name="weight">
            ...
            <div class="sm:grid gap-4 grid-cols-1">
                  <div class="mb-4">
                        ...
                        <label for="exampleFormControlInput1" class="block text-gray-700 text-sm font-bold mb-2">Foto do
                              produto
                              :</label>
                        {{-- <input type="file"
                                                      class="shadow appearance-none border rounded  w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="fotos">
                              ...
                              <div class="img-edit">
                                    <a href="{{ url('products-image-delete/'. $image->id) }}"> <span
                                                class="material-icons delete-img">
                                                cancel
                                          </span></a>
                                    <img src="{{ url('storage/products/'.$image->path) }}" alt="">
                              </div>
                              @endforeach
