...
<div class="px-12 pt-12">
      <h1>Bem vindo ao Painel <strong>{{ Auth::user()->name }}</strong> </h1>
      <h2>Hoje é  {{ date('d-m-Y H:i:s') }} </h2>
      <h2>Esta painel está sempre se atualizando</h2>
</div>
<!-- component -->
<!-- component -->
                  ...
                  <div class="col-span-12 sm:col-span-6 md:col-span-3">
                        <div class="flex flex-row bg-white shadow-sm rounded p-4">
                              ...
                              <div class="flex flex-col flex-grow ml-4">
                                    ...
                                    <div class="font-bold text-lg">{{ $users->count() }}</div>
                              </div>
                        </div>
                  </div>
                  <div class="col-span-12 sm:col-span-6 md:col-span-3">
                        <div class="flex flex-row bg-white shadow-sm rounded p-4">
                              ...
                              <div class="flex flex-col flex-grow ml-4">
                                    ...
                                    <div class="font-bold text-lg">{{ $orders->count() }}</div>
                              </div>
                        </div>
                  </div>
                  <div class="col-span-12 sm:col-span-6 md:col-span-3">
                        <div class="flex flex-row bg-white shadow-sm rounded p-4">
                              ...
                              <div class="flex flex-col flex-grow ml-4">
                                    <div class="text-sm text-gray-500">Novos Clientes</div>
                  ...
                  <div class="col-span-12 sm:col-span-6 md:col-span-3">
                        <div class="flex flex-row bg-white shadow-sm rounded p-4">
                              ...
                              <div class="flex flex-col flex-grow ml-4">
                                    ...
                                    <div class="font-bold text-lg">R$ 0</div>
                              </div>
                        </div>
                  </div>
            </div>
